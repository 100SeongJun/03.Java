...
import blood.transfusion.service.NotExistException;
...
//
		...
		controller.updateProject("as-", new Recipient("recipient6", "수혈6", 22, "F", "B-", "질병"));

		System.out.println();

		// 존재하는 프로젝트 삭제 및 삭제여부 확인
		System.out.println("===== 7. 존재하는 프로젝트 삭제 및 확인 =====");
		controller.deleteProject("A-");
	}
